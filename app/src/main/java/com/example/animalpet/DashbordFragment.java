...
public class DashbordFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        CardView cardToHealthAndStatus = (CardView) view.findViewById(R.id.cardView2);
        ...
        cardViewToMeasurements.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), BioManagements.class);
                startActivity(intent);
            }
        });
        ...
        cardView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), MainPetActivity.class);
                startActivity(intent);
            }
        });
